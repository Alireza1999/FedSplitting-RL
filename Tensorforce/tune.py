...
def main(env):
    ...
    args = dict()
    args['id'] = "worker"
    args['max-episode-timesteps'] = None
    args['level'] = None
    args['import_modules'] = None
    args['num_parallel'] = None
    args['episodes'] = 500
    args['runs_per_round'] = '1,2,5,10'
    args['selection_factor'] = 3
    args['num_iterations'] = 1
    args['directory'] = 'tuner'
    args['restore'] = None
    ...
    worker = TensorforceWorker(
        environment=environment, max_episode_timesteps=args['max-episode-timesteps'],
