...
arguments = {
    '-a': ['--agent', 'tensorforceAgent', '[String] name of the RL agent[ppo, ac, tensorforce, random]'],
...
runner = runner.Runner(agentType=options['agent'], episodeNum=int(options['episode']),
