...
def actionToLayerDiscrete(splitDecision: list) -> tuple:
    op1: int = splitDecision[0] - 1
    op2: int = 0
    remainingLayer = config.LAYER_NUM - splitDecision[0]
    if remainingLayer <= 0:
        op2 = op1
    else:
        op2 = op1 + splitDecision[2]

    if op2 >= config.LAYER_NUM - 1:
